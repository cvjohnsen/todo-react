...
export const fetchTodo = () => (dispatch) => {
  ...
  axios
    .get("https://todo-fullstack-proj.herokuapp.com/todo/")
    .then((data) => {
...
export const addToDo = (todo) => (dispatch) => {
  ...
  console.log(todo);
  axios
    .post("https://todo-fullstack-proj.herokuapp.com/todo/", todo)
...
export const removeToDo = (id, todo) => (dispatch) => {
  dispatch({ type: FETCH_TODO_START });
  axios
    .delete(`https://todo-fullstack-proj.herokuapp.com/todo/${id}`)
...
export const updateTodo = (id, update) => (dispatch) => {
  dispatch({ type: FETCH_TODO_START });
  axios
    .put(`https://todo-fullstack-proj.herokuapp.com/todo/${id}`, update)
    .then((data) =>
